...
$route
    ...
    ->add('GET', '/post/{id}', [PostController::class, 'showPost'])
    ->add('GET', '/post/{id}/edit', [PostController::class, 'showEditPost'])
    ->add('POST', '/edit-post', [PostController::class, 'editPost'])
    ->add('GET', '/users', [UsersController::class, 'index'])
    ->add('GET', "/user/{id}", [UsersController::class, 'showEditPost'])
